# what is this?
This is basically an Overleaf clone. It allows multiple users to simultaneously edit the same document. Documents can also be compiled from LaTeX source into a PDF.
